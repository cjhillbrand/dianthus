...
pub fn fconst_0(thread_id: usize, runtime_data: &mut RunTimeData)
{
    fconst_n(thread_id, runtime_data, 0.)
}

pub fn fconst_1(thread_id: usize, runtime_data: &mut RunTimeData)
{
    fconst_n(thread_id, runtime_data, 1.)
}

pub fn fconst_2(thread_id: usize, runtime_data: &mut RunTimeData)
{
    fconst_n(thread_id, runtime_data, 2.)
}