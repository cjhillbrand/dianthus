...
pub fn iload_0(thread_id: usize, runtime_data: &mut RunTimeData) { iload_n(thread_id, runtime_data, 0); }

pub fn iload_1(thread_id: usize, runtime_data: &mut RunTimeData) { iload_n(thread_id, runtime_data, 1); }

pub fn iload_2(thread_id: usize, runtime_data: &mut RunTimeData) { iload_n(thread_id, runtime_data, 2); }

pub fn iload_3(thread_id: usize, runtime_data: &mut RunTimeData) { iload_n(thread_id, runtime_data, 3); }
...
pub fn istore_0(thread_id: usize, runtime_data: &mut RunTimeData) { istore_n(thread_id, runtime_data, 0); }

pub fn istore_1(thread_id: usize, runtime_data: &mut RunTimeData) { istore_n(thread_id, runtime_data, 1); }
