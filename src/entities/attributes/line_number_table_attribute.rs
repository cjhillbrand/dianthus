...
#[cfg(test)]
mod tests {
    use crate::entities::attributes::line_number_table_attribute::{
        LineNumberTableAttribute, TableElement,
    };
    use crate::vecdeque;
    ...
    fn get_default_line_table_vec() -> VecDeque<u8> {
        vecdeque![1, 1, 1, 1, 1, 1, 0, 1, 1, 1, 1, 1]
    }

    fn get_default_table_elem_vec() -> VecDeque<u8> {
        vecdeque![1, 1, 1, 1]
    }
}
