...
impl JvmValue {
	...
	pub fn to_float(self) -> JvmValue {
		match self {
			JvmValue::Boolean(v) => JvmValue::Float(v as f32),
			JvmValue::Byte(v) => JvmValue::Float(v as f32),
			JvmValue::Char(v) => JvmValue::Float(v as f32),
	...
	pub fn to_double(self) -> JvmValue {
		match self {
			JvmValue::Boolean(v) => JvmValue::Double(v as f64),
			JvmValue::Byte(v) => JvmValue::Double(v as f64),
			JvmValue::Char(v) => JvmValue::Double(v as f64),
