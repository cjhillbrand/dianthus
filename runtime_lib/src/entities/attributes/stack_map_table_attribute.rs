...
impl VerificationTypeInfo
{
    fn new<T: ReadBytes>(data: &mut T) -> VerificationTypeInfo
    {
        ...
        match tag {
          ...
          ITEM_UNINITIALIZED => {
              let uninitialized: UninitializedVariableInfo = UninitializedVariableInfo::new(tag as u8, data.pop_u16());
...
{
    fn new(tag: u8, constant_index: u16) -> ObjectVariableInfo {
        ObjectVariableInfo {
            tag,
            constant_index
        }
...
{
    fn new(tag: u8, offset: u16) -> UninitializedVariableInfo {
